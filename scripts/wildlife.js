...
function checkCompletion() {
  ...
  tiles.forEach((tile, index) => {
    let correctImg = "wildlife" + (index + start) + ".jpg";
...
hintButton.addEventListener("mousedown", function () {
    if (rows === 3) {
        completeImage.src = `./images/wildlife31.jpg`;
    } else if (rows === 4) {
        completeImage.src = `./images/wildlife41.jpg`;
    } else if (rows === 5) {
        completeImage.src = `./images/wildlife51.jpg`;
    }
